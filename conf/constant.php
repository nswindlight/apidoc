...
defined('WEB_NAME')         OR define('WEB_NAME', 'api文档'); // 网站名称
 ...
 * 框架权限系统所需数据表
*/
defined('TB_ADMIN')         OR define('TB_ADMIN', 'tb_admin');
defined('TB_MENU')          OR define('TB_MENU', 'tb_menu');
defined('TB_METHOD')        OR define('TB_METHOD', 'tb_method');
defined('TB_METHOD_MENU')   OR define('TB_METHOD_MENU', 'tb_method_menu');
defined('TB_ROLE')          OR define('TB_ROLE', 'tb_role');
defined('TB_ROLE_POWER')    OR define('TB_ROLE_POWER', 'tb_role_power');
defined('TB_SYS_LOG')       OR define('TB_SYS_LOG', 'tb_sys_log');