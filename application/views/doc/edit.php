        ...
        <div class="box-body">
            <table class="table table-bordered">
                <tr>
                    ...
                    <td>
                        <input type="text" id="api_group" value="<?= $apiData['group'] ?>" class="form-control" placeholder="如：/ucenter,/order...">
                    </td>
                </tr>
                <tr>
                    <th>接口名称</th>
                    <td>
                        <input type="text" id="api_name" value="<?= $apiData['name'] ?>" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th>接口地址</th>
                    <td>
                        <input type="text" id="api_link" value="<?= $apiData['link'] ?>" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th>获取方式</th>
                    <td>
                        <input type="text" id="api_method" value="<?= $apiData['method'] ?>" class="form-control" placeholder="如：POST,GET,DELETE,PUT...">
                    </td>
                </tr>
                <tr>
                    <th>描述信息</th>
                    <td>
                        <textarea id="api_descript" class="form-control" style="min-height: 120px;"><?= $apiData['descript'] ?></textarea>
                    </td>
                </tr>
        ...
        <?php foreach ($requestGroup as $gname=>$group): ?>
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title"><input type="text" class="group_name form-control" value="<?= $gname ?>" placeholder="分组名称"></h3>
                </div>
                <div class="box-body">
                    <table class="table table-bordered param_list">
                        ...
                        <tr>
                            <td><input class="form-control field_name" value="<?= $param['param_name']?>"></td>
                            <td><input class="form-control field_type" value="<?= $param['param_type']?>"></td>
                            <td><input class="field_is_must" <?= $param['is_must'] > 0? 'checked':''?> type="checkbox"/> 必须</td>
                            <td><input class="form-control field_info" value="<?= $param['info'] ?>"></td>
                            <td><input class="form-control field_more" value="<?= $param['more'] ?>"></td>
                ...
                <div class="box-body">
                    <table class="table table-bordered param_list">
                        ...
                        <tr>
                            <td><input class="form-control field_name" value="<?= $param['param_name'] ?>"></td>
                            <td><input class="form-control field_type" value="<?= $param['param_type'] ?>"></td>
                            <td><input class="form-control field_more" value="<?= $param['info'] ?>"></td>
                            <td><button type="button" class="btn btn-danger btn-sm del_field"><i class="fa fa-trash"></i>删除</button></td>
                        </tr>
                        <?php endforeach;?>
                        </tbody>
    ...
    <div class="box box-danger" id="err_code">
        ...
        <div class="box-body">
            <table class="table table-bordered param_list">
                ...
                <tr>
                    <td><input class="form-control field_code" value="<?= $v['code'] ?>"></td>
                    <td><input class="form-control field_more" value="<?= $v['info'] ?>"></td>
                    <td><button type="button" class="btn btn-danger btn-sm del_field"><i class="fa fa-trash"></i>删除</button></td>
                </tr>
                <?php endforeach;?>
                <?php endif; ?>
...
<script>
    ...
    $("#save-btn").click(function(){
        ...
        var op = {
            url:'<?= site_url("doc/edit/".$apiData["id"]) ?>',
            data: form_data,
